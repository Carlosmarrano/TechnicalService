...
export const AboutPage = () => {
    return (
        <TechnicalLayout>
            <Grid container sx={{marginTop: 20, display: "flex", alignItems: "center", justifyContent: "center" ,flexDirection: "column", gap: 6, marginRight: {lg: 12}}}>
                <Box>
                ...
                <Box sx={{ display: "flex", flexDirection: { xs: "column", lg: "row" }, justifyContent: "space-between", gap: 4}}>
                    <Box sx={{flex: 1, border: "1px solid secondary.main", boxShadow: 4, padding: 4, borderRadius: 2, textAlign: "center", display: "flex", flexDirection: "column", alignItems: "center", gap: 1}}>
                        ...
                        <Typography>Razón de base por la que nuestro fundador piloto y actual regente, chicho javier, enfatiza en brindar soluciones basadas en su tiempo, presupuesto y necesidad,Siendo el lema de nuestra empresa Su electrodoméstico queda seguro, reparado y funcional en nuestras manos"</Typography>
